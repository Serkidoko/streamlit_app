...
CONFIG_FILE = "/home/doducanh/Downloads/data/code_up/config_LLM_FULL.json"
# FILE_PATH = "/home/ninh/phenikaax/virtual_assistant/Trien_khai/chatbot_tuyen_sinh/upload_data_to_server/data_raw/Tổng hợp tài liệu.xlsx"
...
#     model_name_or_path="/home/ninh/phenikaax/reception/llm/test/search_llm/finetune_embed/finetune/test_model_lower"
# )
...
for name_dir in name_directories:
    ...
    INDEX_NAME = f"llm-full-{name_dir}-2024.04.24".lower()
    if docx_files != []:
        create_index(
            client=client,
            index=INDEX_NAME,
        ...
        for file_doc in docx_files:
            ...
            try:
                ...
                text_splitter = RecursiveCharacterTextSplitter.from_huggingface_tokenizer(chunk_size=1000, chunk_overlap=0, tokenizer = model_tokenizer)
